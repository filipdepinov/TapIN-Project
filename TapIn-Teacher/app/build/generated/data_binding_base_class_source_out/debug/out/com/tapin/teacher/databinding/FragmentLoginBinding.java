...
public final class FragmentLoginBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearProgressIndicator progressLogin;
  ...
  private FragmentLoginBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnLogin,
      ...
      @NonNull TextInputEditText etPassword, @NonNull LinearProgressIndicator progressLogin,
      @NonNull TextInputLayout tilEmail, @NonNull TextInputLayout tilPassword,
      @NonNull TextView tvError, @NonNull TextView tvSubtitle, @NonNull TextView tvTitle) {
  ...
  public static FragmentLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      LinearProgressIndicator progressLogin = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentLoginBinding((ScrollView) rootView, btnLogin, cardLogin, etEmail,
          etPassword, progressLogin, tilEmail, tilPassword, tvError, tvSubtitle, tvTitle);
    }
