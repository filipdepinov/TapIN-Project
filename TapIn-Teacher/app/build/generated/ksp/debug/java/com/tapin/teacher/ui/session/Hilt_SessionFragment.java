...
public abstract class Hilt_SessionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SessionFragment() {
    super();
  }

  Hilt_SessionFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SessionFragment_GeneratedInjector) this.generatedComponent()).injectSessionFragment(UnsafeCasts.<SessionFragment>unsafeCast(this));
    }
  }
