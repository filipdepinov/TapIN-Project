...
public final class FragmentLoginBinding implements ViewBinding {
  ...
  private FragmentLoginBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnLogin,
      ...
      @NonNull LinearProgressIndicator progressLogin, @NonNull TextInputLayout tilEmail,
      @NonNull TextInputLayout tilPassword, @NonNull TextView tvAppName, @NonNull TextView tvError,
      @NonNull TextView tvSubtitle, @NonNull TextView tvVersion) {
  ...
  public static FragmentLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLoginBinding((ScrollView) rootView, btnLogin, cardLogin, etEmail,
          etPassword, ivLogo, progressLogin, tilEmail, tilPassword, tvAppName, tvError, tvSubtitle,
          tvVersion);
    }
